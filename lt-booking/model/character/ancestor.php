...
/*+----------------------------------------------------------------------------
 ...
 ||
 || File public/model/character/ancestor.php
 ||     Author: Pete Allison
...
class CharacterAncestor extends Model {
	/**
	 * Returns all of the registered ancestors
	 *
	 * @return array
	 */
	public function getAll() {
		...
		$query = $this->db->query("
			SELECT
			  anID AS `ancestor_id`,
			  anName AS `ancestor_name`
			FROM " . DB_PREFIX . "ancestors
			WHERE anName <> 'Other (enter name below)'
